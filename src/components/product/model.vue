  ...
  <div>
    <div>
      ...
      <div class="productdiv">
        ...
        <div>
          <!--表格-->
          <el-table :data="modelData" height="500" border style="width: 100%" header-align="center">
            <el-table-column prop="project_name" label="所属项目" width="140" align="center"></el-table-column>
            <el-table-column prop="model_name" label="模块名称"  align="center">
              <template slot-scope="scope">
                <div>
                  <el-tag v-for="item in scope.row.model_name.split(',')" :key="item"  style="margin-right: 5px">{{item}}</el-tag>
                </div>
              </template>
            </el-table-column>
            <el-table-column prop="create_time" label="模块创建时间" align="center" width="180"></el-table-column>
            <el-table-column prop="create_user" label="模块创建人" align="center" width="180"></el-table-column>
        ...
        <el-form :model="modelform" :rules="rules" label-width="80px">
          ...
          <el-form-item label="模块名称" prop="name" class="modelcs">
            <el-select v-model="modelform.model_name" style="width: 100%" multiple filterable allow-create
                       default-first-option placeholder="请输入模块名称"></el-select>
          </el-form-item>
